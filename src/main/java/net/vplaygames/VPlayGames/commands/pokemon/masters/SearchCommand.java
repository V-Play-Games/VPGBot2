...
public class SearchCommand extends Command {
    ...
    public void onCommandRun(CommandReceivedEvent e) {
        ...
        if (isTurnable(type)) {
            ...
            e.send(e.getAuthor().getAsMention() + ", You have opened a new " + type.toString().toLowerCase() + " search query!\n" +
                "Any previous queries of yours will not be used to turn pages with `" + PREFIX + "next` & `" + PREFIX + "back`").queue();
        } else {
