...
public class database
{
    ...
    public static String[] pkmns = {"Pikachu","Torchic","Solgaleo","Onix","Tyranitar","Starmie","Voltorb","Electrode","Vileplume","Ponyta",
          ...
          smoves = {"Thunder of Newfound Passion","Fire Sync Impact","Shining Friendship Sunraze Smash","Rock-Solid Rockslide","Sygnature Rock-Solid Stone Edge","Tomboyish Mermaid Bubble Beam","Electric Sync Beam","Surging Charge Beam","Nature-Loving Petal Dance","Fire Sync Impact",
            ...
            "Solid Steel Meteor Mash","Too Cool Icicle Crash","Pok�mon Professor Psychic","Fashionista Dazzling Gleam","Living Legend Blast Burn","Living Legend Blast Burn","ESP Prodigy Psywave","ESP Prodigy Psywave","Soulful Dancer Shadow Ball","Wicked Enforcer Acid Downpour",
